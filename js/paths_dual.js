...
PA.drawBiline = function( x , y ) {
	var p, dir, line1_points, line2_points, biline_points, biline_path, last_point_was_ob, np;
	...
	PA.drawLine(PA.getLine( p, dir, true ));

	// draw the second part of the line in the opposite direction
	PA.drawLine(PA.getLine( p, ( dir + 4 ) % 8, false ));
};
